...
impl Engine {
    ...
    fn run_effect(&mut self, effect: Effect) {
        match effect {
            ...
            // The message list, streaming buffer, conversation list, tasks,
            // scratchpad, voice, and client-tool effects are either re-derived
            // in `sync_view` or out of scope for the foundation. Deliberately
            // ignored (their screens land later).
            _ => {}
        }
    }
